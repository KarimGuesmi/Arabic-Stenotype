...
public class NextWordsBuffer {
	...
	// fill a new line
	private void fillNewLine(int previousWordIndex) {
	...
	private boolean isSingleWordBuffer() {
		return bufferSize==1;
		
	}

	//Compute the next word
	private int getNextWordFromPool(int previousWordIndex, long[] penaltyLimits) {
		// create word pool
	...
	private int map(long wordPenalty, long l, long m, int i, int j) {
		// TODO Auto-generated method stub
		return 0;
	}

	//calculate min&max penalty limits
	private long[] calculatePenaltyLimits() {
